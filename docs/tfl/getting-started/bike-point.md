...
`GET /BikePoint` returns Santander Cycles (cycle hire) docking stations with locations and availability. It's one of the operations in the [API playground](/tfl/api-playground).
