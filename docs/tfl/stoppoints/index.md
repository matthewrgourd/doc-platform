...
- **Search**: `GET /StopPoint/Search/{query}`. See the [guide](/tfl/stoppoints/search). Included in **[tfl-playground.json](/openapi/tfl-playground.json)**.

## Other endpoints on the live API

These aren't in the downloadable playground spec:

- **Arrivals**: `GET /StopPoint/{ids}/Arrivals`. See the [arrivals guide](/tfl/stoppoints/arrivals).
...
- [**Arrivals**](/tfl/stoppoints/arrivals): next departures outside the playground spec
