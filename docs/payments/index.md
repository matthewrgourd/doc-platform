...
- [**Accept a Payment**](./accept-a-payment)  - Process a card payment from start to finish
- [**Refunds**](./refunds)  - Issue full or partial refunds
- [**Webhooks**](./webhooks)  - Get notified about payment events in real time
